...
// Thread safe tradebee_logger (except for set_error_handler())
// Has name, log level, vector of std::shared sink pointers and formatter
// Upon each log write the tradebee_logger:
...
#    define SPDLOG_LOGGER_CATCH()                                                                                                          \
        ...
        {                                                                                                                                  \
            err_handler_("Rethrowing unknown exception in tradebee_logger");                                                                        \
            throw;                                                                                                                         \
        }
#else
#    define SPDLOG_LOGGER_CATCH()
...
public:
    ...
    // set formatting for the sinks in this tradebee_logger.
    ...
    // create new tradebee_logger with same sinks and configuration.
